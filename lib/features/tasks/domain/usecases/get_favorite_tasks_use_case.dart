...
@lazySingleton
class GetFavoriteTasksUseCase implements UseCase<List<Task>, NoParams> {
  final TasksRepository _tasksRepository;

  const GetFavoriteTasksUseCase(this._tasksRepository);

  @override
  Future<Either<Failure, List<Task>>> call(NoParams params) =>
      _tasksRepository.getFavoriteTasks();
}
